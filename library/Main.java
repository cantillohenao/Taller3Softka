...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        infoList.add(new Info("lamda", "madness", 3, 2003, 3.12f, "b", "memories.jpg", "Cancion 3 del album memories"));
        infoList.add(new Info("muse", "knights", 4, 2001, 4.11f, "a", "memories.jpg", "Cancion 4 del album memories"));
        infoList.add(new Info("muse", "knights", 4, 2001, 4.11f, "a", "memories.jpg", "Cancion 4 del album memories"));
        String[] genderList = {"rock", "punk", "rock", "jazz", "reggae"};
...
//        infoList.stream().filter(l -> l.getYear() == opcion1).forEach(System.out::println);
        System.out.println("****************");
        System.out.println("Que genero deseas filtrar: 1)rock 2)reggae 3) jazz 4)punk. Ingresa el numero correspondiente");
